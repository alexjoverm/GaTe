...
${OBJECTDIR}/Clases/HUD/Improve.o: Clases/HUD/Improve.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/HUD
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/HUD/Improve.o Clases/HUD/Improve.cpp

${OBJECTDIR}/Clases/HUD/ImproveGroup.o: Clases/HUD/ImproveGroup.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/HUD
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/HUD/ImproveGroup.o Clases/HUD/ImproveGroup.cpp
...
${OBJECTDIR}/Clases/Otros/TemporalChange.o: Clases/Otros/TemporalChange.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/Otros
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Otros/TemporalChange.o Clases/Otros/TemporalChange.cpp
...
${OBJECTDIR}/Clases/States/ShopState.o: Clases/States/ShopState.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/States
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/States/ShopState.o Clases/States/ShopState.cpp
