...
OBJECTFILES= \
	...
	${OBJECTDIR}/Clases/Otros/TemporalChange.o \
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hito2_alvarofinal

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hito2_alvarofinal: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hito2_alvarofinal ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/Clases/Entities/PowerUp.o: Clases/Entities/PowerUp.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/Entities
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Entities/PowerUp.o Clases/Entities/PowerUp.cpp

${OBJECTDIR}/Clases/Entities/Tower.o: Clases/Entities/Tower.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/Entities
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Entities/Tower.o Clases/Entities/Tower.cpp

${OBJECTDIR}/Clases/Factories/EntityFactory.o: Clases/Factories/EntityFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/Factories
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Factories/EntityFactory.o Clases/Factories/EntityFactory.cpp
...
${OBJECTDIR}/Clases/Managers/ConfigurationManager.o: Clases/Managers/ConfigurationManager.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Managers/ConfigurationManager.o Clases/Managers/ConfigurationManager.cpp
...
${OBJECTDIR}/Clases/Managers/PowerUpManager.o: Clases/Managers/PowerUpManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/Managers
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Managers/PowerUpManager.o Clases/Managers/PowerUpManager.cpp
...
${OBJECTDIR}/Clases/Managers/StatusManager.o: Clases/Managers/StatusManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/Managers
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Managers/StatusManager.o Clases/Managers/StatusManager.cpp

${OBJECTDIR}/Clases/Managers/WaveManager.o: Clases/Managers/WaveManager.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/Managers
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Managers/WaveManager.o Clases/Managers/WaveManager.cpp

${OBJECTDIR}/Clases/Motor2D/Camera.o: Clases/Motor2D/Camera.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/Motor2D
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Motor2D/Camera.o Clases/Motor2D/Camera.cpp
...
${OBJECTDIR}/Clases/Motor2D/Paralax.o: Clases/Motor2D/Paralax.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/Motor2D
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Motor2D/Paralax.o Clases/Motor2D/Paralax.cpp
...
${OBJECTDIR}/Clases/MusicSounds/MusicPlayer.o: Clases/MusicSounds/MusicPlayer.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/MusicSounds/MusicPlayer.o Clases/MusicSounds/MusicPlayer.cpp

${OBJECTDIR}/Clases/MusicSounds/SoundPlayer.o: Clases/MusicSounds/SoundPlayer.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/MusicSounds
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/MusicSounds/SoundPlayer.o Clases/MusicSounds/SoundPlayer.cpp
...
${OBJECTDIR}/Clases/Otros/TemporalChange.o: Clases/Otros/TemporalChange.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/Otros
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/Otros/TemporalChange.o Clases/Otros/TemporalChange.cpp
...
${OBJECTDIR}/Clases/States/CreditsState.o: Clases/States/CreditsState.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/States/CreditsState.o Clases/States/CreditsState.cpp
...
${OBJECTDIR}/Clases/States/NewTowerState.o: Clases/States/NewTowerState.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/States
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/States/NewTowerState.o Clases/States/NewTowerState.cpp

${OBJECTDIR}/Clases/States/PauseState.o: Clases/States/PauseState.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/States
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/States/PauseState.o Clases/States/PauseState.cpp
...
${OBJECTDIR}/Clases/States/TutorialState.o: Clases/States/TutorialState.cpp 
	${MKDIR} -p ${OBJECTDIR}/Clases/States
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/SFML/include -IIncludes -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Clases/States/TutorialState.o Clases/States/TutorialState.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/hito2_alvarofinal
